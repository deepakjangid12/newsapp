  ...
  return (
    <div className='my-3'>
      <div className="card"  >
        ...
        <img src={props.image ? props.image : "https://englishtribuneimages.blob.core.windows.net/gallary-content/2023/7/2023_7$largeimg_703261718.JPG"} className="card-img-top" alt="..."  style={{ maxWidth: '100%', maxHeight: '300px', objectFit: 'cover' }}
    />
